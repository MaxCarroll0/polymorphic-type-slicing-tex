...
\end{itemize}
Here ``$e$ marks to $\chk e$ at focus mode $m$'' means: if $m = {\color{BrickRed}\Uparrow}\;\tau'$ then $\synmark[\Delta';\,\Gamma']{e}{\chk e}{\tau'}$; if $m = {\color{BlueViolet}\Downarrow}\;\tau'$ then $\anamark[\Delta';\,\Gamma']{e}{\chk e}{\tau'}$.
\end{theorem}
\end{majortheorembox}
