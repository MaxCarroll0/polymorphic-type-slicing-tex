...
\path let \p1=(orig.south west), \p2=(orig.south east) in
  node[anchor=north west, font=\scriptsize, align=center, inner sep=5pt,
       ...
       (errbox) at (\p1)
       {term has type \synsrc{\texttt{Digit \textrightarrow\ String \textrightarrow\ Option (String × Pin)}}
        but was expected to have type \anasrc{\texttt{Digit \textrightarrow\ Option (String × Pin)}}};
