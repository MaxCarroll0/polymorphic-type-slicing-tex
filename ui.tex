...
\textit{\footnotesize\color{black!55}select} & \texttt{parse\_digit} \\
\textit{\footnotesize\color{black!55}query}  & $\upsilon \;=\; \synsrc{\texttt{Char → Option Digit}}$
\end{tabular}
\par\smallskip
...
\smallskip
\begin{tabular}{@{}r@{\hspace{0.7em}}l@{}}
\textit{\footnotesize\color{black!55}select} & \texttt{'5'} \\
\textit{\footnotesize\color{black!55}query}  & $\upsilon \;=\; \anasrc{\texttt{Char}}$
\end{tabular}
\par\smallskip
...
\quad \kwd{fun}\ (f \kwd{:} \ty{A -\textgreater\ Option (String × B)}) \kwd{-\textgreater}\\
\quad \kwd{fun}\ (s \kwd{:} \ty{String}) \kwd{-\textgreater}\\
\quad\quad \kwd{case} p(s) \kwd{of}\\
\quad\quad\quad \kwd{|} \ty{None} \kwd{-\textgreater}\ \ty{None}\\
\quad\quad\quad \kwd{|} \ty{Some(}s', a\ty{)} \kwd{-\textgreater}\ f\ a\\
\kwd{let} is\_digit \kwd{=} \kwd{fun}\ (s \kwd{:} \ty{String}) \kwd{-\textgreater}\ $\cdots$\\
\kwd{let} parse\_pin \kwd{=} \kwd{fun}\ (s \kwd{:} \ty{String}) \kwd{-\textgreater}\\
\quad bind-parser\ty{<Digit><Pin>}\ is\_digit (\kwd{fun}\ (d\textsubscript{1} \kwd{:} \ty{Digit}) \kwd{-\textgreater}\\
\quad bind-parser\ty{<Digit><Pin>}\ is\_digit (\kwd{fun}\ (d\textsubscript{2} \kwd{:} \ty{Digit}) \kwd{-\textgreater}\\
\quad bind-parser\ty{<Digit><Pin>}\ is\_digit (\kwd{fun}\ (d\textsubscript{3} \kwd{:} \ty{Digit}) \kwd{-\textgreater}\\
\quad\quad bind-parser\ty{<Digit><Pin>}\ is\_digit (\\
\quad\quad\quad \focusbox{\squiggle{\kwd{fun}\ (d\textsubscript{4} \kwd{:} \ty{Digit}) \kwd{-\textgreater}\ \kwd{fun}\ (s' \kwd{:} \ty{String}) \kwd{-\textgreater}}\\ \quad \squiggle{\ty{Some(}s', (d\textsubscript{1}, d\textsubscript{2}, d\textsubscript{3}, d\textsubscript{4})\ty{)}}}))))) \\
...
\coordinate (fullTop)    at (0,-10.5);
\coordinate (refinedTop) at (0,-18.0);

% Local: per-stage query label commands.
\newcommand{\synquery}[1]{%
  \begin{minipage}[t]{6.5cm}\centering
  {\scriptsize\itshape\color{black!55}query }{\scriptsize$\upsilon\,=\,$}{\scriptsize\synsrc{#1}}%
  \end{minipage}}
\newcommand{\anaquery}[1]{%
  \begin{minipage}[t]{6.5cm}\centering
  {\scriptsize\itshape\color{black!55}query }{\scriptsize$\upsilon\,=\,$}{\scriptsize\anasrc{#1}}%
  \end{minipage}}
...
\quad \fold\ \strN{(}\strN{fun} \synsrc{(}\asmref{d\textsubscript{1}} \strN{:} \synsrc{Digit}\synsrc{)} \strN{-\textgreater}\\
\quad \fold\ \strN{(}\strN{fun} \synsrc{(}\asmref{d\textsubscript{2}} \strN{:} \synsrc{Digit}\synsrc{)} \strN{-\textgreater}\\
\quad \fold\ \strN{(}\strN{fun} \synsrc{(}\asmref{d\textsubscript{3}} \strN{:} \synsrc{Digit}\synsrc{)} \strN{-\textgreater}\\
\quad \fold\ \strN{(}\\
\quad\quad \focusbox{\squiggle{\synsrcS{fun}\ \synsrc{(}\asmref{d\textsubscript{4}} \synsrc{:} \synsrcS{Digit}\synsrc{)} \synsrcS{-\textgreater}\ \synsrcS{fun}\ \synsrc{(}\asmref{s'} \synsrc{:} \synsrcS{String}\synsrc{)} \synsrcS{-\textgreater}}\\ \quad\squiggle{\synsrcS{Some(s', (d\textsubscript{1}, d\textsubscript{2}, d\textsubscript{3}, d\textsubscript{4}))}}}\\
\quad \strN{))))}\\
\strN{in} \fold%
}};
\node[anchor=south, inner sep=3pt] (synFullQuery) at (synFull.north)
  {\synquery{Digit \textrightarrow\ String \textrightarrow\ Option (String × Pin)}};

\node[codebox] (synRefined) at ($(refinedTop)+(\colL,0)$) {\slicebody{%
\fold\\
\strN{let} \fold\ \strN{=} \strN{fun} \fold\ \strN{-\textgreater}\\
\quad \fold\ \strN{(}\strN{fun} \fold\ \strN{-\textgreater}\\
\quad \fold\ \strN{(}\strN{fun} \fold\ \strN{-\textgreater}\\
\quad \fold\ \strN{(}\strN{fun} \fold\ \strN{-\textgreater}\\
\quad \fold\ \strN{(}\\
\quad\quad \focusbox{\squiggle{\synsrcS{fun} \fold\ \synsrcS{-\textgreater}\ \synsrcS{fun} \fold\ \synsrcS{-\textgreater}\ \fold}}\\
\quad \strN{))))}\\
\strN{in} \fold%
}};
\node[anchor=south, inner sep=3pt] (synRefinedQuery) at (synRefined.north)
  {\synquery{\fold\ \textrightarrow\ (\fold\ \textrightarrow\ \fold)}};
...
\quad \anasrc{fun} \anasrc{(}\fold\ \strN{:} \anasrc{A} \anasrcS{-\textgreater\ Option (String ×} \anasrc{B}\anasrcS{)}\anasrc{)} \anasrc{-\textgreater}\\
\quad \fold\\
\strN{let} \fold\ \strN{=} \strN{fun} \fold\ \strN{-\textgreater}\\
...
\node[anchor=south, inner sep=3pt] (anaFullQuery) at (anaFull.north)
  {\anaquery{Digit \textrightarrow\ Option (String × Pin)}};
...
\quad \anasrc{fun} \anasrc{(}\fold\anasrc{)} \anasrc{-\textgreater}\\
\quad \anasrc{fun} \anasrc{(}\fold\ \strN{:} \fold\ \anasrcS{-\textgreater}\ \anasrcS{Option}\ \fold\anasrc{)} \anasrc{-\textgreater}\\
\quad \fold\\
\strN{let} \fold\ \strN{=} \strN{fun} \fold\ \strN{-\textgreater}\\
\quad \fold\ \fold\ \strN{(fun} \fold\ \strN{-\textgreater}\\
\quad \fold\ \fold\ \strN{(fun} \fold\ \strN{-\textgreater}\\
...
\node[anchor=south, inner sep=3pt] (anaRefinedQuery) at (anaRefined.north)
  {\anaquery{\fold\ \textrightarrow\ Option \fold}};

% --- Branching arrows from the root to each full-stage query ---
\draw[branchedge] (orig.south) to[bend right=18]
   node[arrowlbl, pos=0.45] {synthesis query} (synFullQuery.north);
\draw[branchedge] (orig.south) to[bend left=18]
   node[arrowlbl, pos=0.45] {analysis query} (anaFullQuery.north);
...
\node[anchor=south, inner sep=3pt] (fullQuery) at (fullSlice.north)
  {\synqueryT{Char -\textgreater\ Digit + String}};
...
\node[anchor=south, inner sep=3pt] (legQuery) at (legSlice.north)
  {\synqueryT{Char -\textgreater\ Digit + \fold}};
...
\node[anchor=south, inner sep=3pt] (restQuery) at (restSlice.north)
  {\synqueryT{Char -\textgreater\ \fold\ + String}};
