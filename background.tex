...
\node (a1) at (-1.05, -3.2) {$a_1$};
\node (b1) at ( 1.05, -3.2) {$b_1$};
\draw[->, Mahogany!80, line width=0.55pt] (a1) -- node[above, font=\scriptsize, Mahogany!75!black] {$\sqsubseteq_1$} (b1);
...
\begin{scope}[on background layer]
  \node[draw=Mahogany!50, fill=Mahogany!5, rounded corners=4pt, line width=0.5pt,
        ...
        label={[font=\scriptsize\itshape, Mahogany!75!black]below:$L_1$}] (lat1) {};
...
\draw[-{Implies[]}, double, double distance=1.4pt, gray!60, line width=0.4pt] (lat1.north) to[bend right=15] (latP.south);
